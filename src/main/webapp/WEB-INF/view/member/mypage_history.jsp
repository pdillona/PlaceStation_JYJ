					...
					<div style="width: 100%;">
						<ul class="list-group" style="text-align: center;">
							<li class="list-group-item disabled" aria-disabled="true"><a
								href="/Titan-master/faq.html">결제내역 A disabled item</a></li>
							<li class="list-group-item"><a href="/Titan-master/faq.html">찜목록
									A second item</a></li>
							<li class="list-group-item"><a href="/Titan-master/faq.html">문의
									내역 A third item</a></li>
							<li class="list-group-item"><a href="/Titan-master/faq.html">내정보
									변경 A fourth item</a></li>
						</ul>
					</div>
				</div>
						...
						<div class="row mt-2">
							<div class="col-md-6">
								<label class="labels">Name</label><input type="text"
									class="form-control" placeholder="first name" value="" readonly>
							</div>
							<div class="col-md-6">
								<label class="labels">password</label><input type="text"
									class="form-control" value="" placeholder="surname" readonly>
							</div>
						</div>
						<div class="row mt-3">
							<div class="col-md-12">
